...
#include "Animation/AnimNotify/AnimNotify_MeleeAttackStart.h"
#include "Weapon/EquipComponent.h"
#include "Weapon/MeleeWeapon.h"

void UAnimNotify_MeleeAttackStart::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	if (MeshComp == nullptr)
		return;
